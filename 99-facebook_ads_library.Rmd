...
For instance, in our case above, we get not only UK regions columns, but also all of the US states! In eality, there was only one ad that targeted both US and UK in our small sample. This means, that the extraction of the region data could take quite a bit longer than that of the other data. Practically, we would probably need to consider careful data cleaning after closely inspecting the dataset.
