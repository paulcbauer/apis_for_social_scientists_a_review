...
Application programming interfaces (APIs) are an increasingly relevant tool for researchers to access data or services of various private or governmental platforms. Below we review different data- and service-APIs that may be useful to social scientists. Each chapter follows a systematic set of questions: 
