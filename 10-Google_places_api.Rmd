...
file_name <- dir()[stringr::str_detect(dir(), "Google_places_api.Rmd")]
...
```{r google-places-3, echo=TRUE, eval=FALSE}
...
```{r google-places-4, echo=TRUE, eval=F}
key <- "YOURAPIKEY"
set_key(key)
```
...
```{r google-places-7, echo = FALSE, message = FALSE}
...
```{r google-places-14, echo=T, eval=F, warning=F, message=F}
