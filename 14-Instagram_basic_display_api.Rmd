...
file_name <- dir()[stringr::str_detect(dir(), "Instagram_basic_display_api.Rmd")]
...
```{r instagram-basic-display-4, pressure, eval=F, warning=F, message=F}
library(httr)
...
```{r instagram-basic-display-5, pressure2, eval=F, echo=T, message=F, warning=F}
accessToken = "..."
userId = "..."
