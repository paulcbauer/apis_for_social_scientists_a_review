...
```{r google-nlp-3, echo=TRUE, eval=FALSE, comment=NA}
...
```{r google-nlp-4, echo=TRUE, eval=FALSE, comment=NA}
{
  "document":{
    "type":"PLAIN_TEXT",
...
```{r google-nlp-5, echo=TRUE, eval=FALSE, comment=NA}
...
```{r google-nlp-7, eval=FALSE, comment=NA}
...
```{r, google-nlp-10, echo = FALSE, message = FALSE, comment=NA}
...
```{r, google-nlp-12, echo = FALSE, message = FALSE, comment=NA}
