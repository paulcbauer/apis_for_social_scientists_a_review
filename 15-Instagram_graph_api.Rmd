...
file_name <- dir()[stringr::str_detect(dir(), "Instagram_graph_api.Rmd")]
...
```{r instagram-graph-4, echo=TRUE, eval=FALSE}
...
```{r instagram-graph-6, echo=TRUE, eval=FALSE}
...
```{r instagram-graph-8, echo=TRUE, eval=FALSE}
