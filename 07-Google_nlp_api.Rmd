...
```{r google-nlp-3, echo=FALSE, comment=NA}
# Run this and copy output into the p_load function in next chunk
lines_text <- readLines("07-Google_nlp_api.Rmd")
...
packages <- paste("# install.packages('pacman')\n", "library(pacman)\n", "p_load('", paste(packages, collapse="', '"), "')",sep="")
cat(packages)
```
