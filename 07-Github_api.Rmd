...
```{r github-api-7, eval=FALSE}
curl https://api.github.com/repos/tidyverse/dplyr
```

```{r github-api-8, eval=FALSE}
{
  "id": 6427813,
  "name": "dplyr",
