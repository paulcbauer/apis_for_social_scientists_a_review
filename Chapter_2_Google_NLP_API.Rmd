...
data_syntax <- gl_nlp(data_tweets$text_en, nlp_type = "analyzeSyntax")
```
...
```{r echo=TRUE, message=FALSE, warning=FALSE, fig.cap = "Wordcloud of nouns found within tweets"}
# Have a look
...
# If you no longer need your original data (or put differently, if you are only interested in the single tokens and their respective tag), consider this alternative:
# Bind class of words with respective words in sentence

#syntax_short_df <- cbind(data_syntax[["tokens"]][[1]][["tag"]], 
